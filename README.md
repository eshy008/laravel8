...
//This are stuffs i learnt from my laravel course.
...
php artisan migrate
php artisan migrate:rollback <-- use to revert back a migration -->
 php artisan migrate:refresh <!-- use to rollback and migrate -->

<!-- /note here that we used the use() function. Seeding is adding details to the database. this is used for seeding -->
php artisan db:seed --class=StudentSeeder

<!-- to create a factory, one has to create a model first. and the model should be *student not students* -->
